...
scatter = alt.Chart(df,title="My new chart title").mark_point(size=100,opacity=.2,color='green',fill='green').encode(
...
bar = alt.Chart(source).mark_bar(color='#03cffc').encode(
    alt.X("IMDB_Rating:Q", bin=True,title='IMDRating'),
